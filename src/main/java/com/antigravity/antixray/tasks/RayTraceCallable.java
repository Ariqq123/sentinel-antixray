package com.antigravity.antixray.tasks;
...
import com.antigravity.antixray.data.LongWrapper;
import com.antigravity.antixray.data.MutableLongWrapper;
import com.antigravity.antixray.data.PlayerData;
import com.antigravity.antixray.data.Result;
import com.antigravity.antixray.data.VectorialLocation;
import com.antigravity.antixray.util.BlockIterator;
import com.antigravity.antixray.util.BlockOcclusionCulling;
import com.antigravity.antixray.util.BlockOcclusionCulling.BlockOcclusionGetter;
...
public final class RayTraceCallable implements Callable<Void> {
    ...
    public RayTraceCallable(SentinelAntiXray plugin, PlayerData playerData) {
        this.plugin = plugin;
    ...
    public Void call() {
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "An error occured on the SentinelAntiXray tick thread", t);
            throw t;
        }
