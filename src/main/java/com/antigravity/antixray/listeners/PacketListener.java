package com.antigravity.antixray.listeners;
...
import com.antigravity.antixray.tasks.RayTraceCallable;
...
public final class PacketListener extends PacketAdapter {
    ...
    public PacketListener(SentinelAntiXray plugin) {
    ...
    public void onPacketSending(PacketEvent event) {
        ...
        if (packetType == PacketType.Play.Server.MAP_CHUNK) {
            ...
            if (chunkBlocks == null) {
                // SentinelAntiXray is probably not enabled in this world (or other plugins bypass Anti-Xray).
                ...
                if (!location.getWorld().equals(playerData.getLocations()[0].getWorld())) {
                    ...
                    // In the event order listing above, this corresponds to (4) when SentinelAntiXray is disabled in world B.
                    // The player's current world is world B since (2).
                    playerData = new PlayerData(SentinelAntiXray.getLocations(player, new VectorialLocation(location)));
