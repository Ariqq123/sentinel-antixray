...
import com.azreyzaako.antixray.data.LongWrapper;
import com.azreyzaako.antixray.data.MutableLongWrapper;
import com.azreyzaako.antixray.data.PlayerData;
import com.azreyzaako.antixray.data.Result;
import com.azreyzaako.antixray.data.VectorialLocation;
import com.azreyzaako.antixray.util.BlockIterator;
import com.azreyzaako.antixray.util.BlockOcclusionCulling;
import com.azreyzaako.antixray.util.BlockOcclusionCulling.BlockOcclusionGetter;
        ...
        cachedSectionBlockOcclusionGetter = new CachedSectionBlockOcclusionGetter() {
            ...
            public boolean isOccluding(int x, int y, int z) {
                ...
                if (this.chunkX != chunkX || this.chunkZ != chunkZ) {
                    ...
                    if (sectionY < minSectionY || sectionY >= chunk.getMaxSection()) {
                        return false;
                    }
